...
def plotGraph(G, option, position=None):
    ...
    ----------
    G : NetworkX graph
    option : if 1, edges with weight greater then 0 are enlarged.
             The opposite happens for option equal to 0.
    position : nodes position

    Returns
    -------
    position: nodes position generated during plot
              (or same positions if supplied).
    """
    if option == 1:
...
if __name__ == '__main__':
    ...
    edges = [('Pouso Alegre', 'Santa Rita'),
             ('Pouso Alegre', 'Varginha'),
             ('Pouso Alegre', 'Congonhal'),
             ('Pouso Alegre', 'Cachoeira de Minas'),
             ('Santa Rita', 'Pouso Alegre'),
             ('Santa Rita', 'Itajuba'),
             ('Santa Rita', 'Cachoeira de Minas'),
             ('Itajuba', 'Santa Rita'),
             ('Varginha', 'Belo Horizonte'),
             ('Varginha', 'Pouso Alegre'),
             ('Cachoeira de Minas', 'Santa Rita'),
